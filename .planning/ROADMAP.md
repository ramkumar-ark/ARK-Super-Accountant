...
Plans:
- [x] 03-01-PLAN.md — Backend model & enum foundation: GstApplicabilityType, FindingSeverity/ResolveStatus extension, PreconfiguredMaster/ParsedLedger new fields, JPQL fix, DataInitializer idempotency, onboard slug routing (complete 2026-05-06)
- [x] 03-02-PLAN.md — Validation rules (TDD): TdsSectionMappingRule, GstApplicabilityRule, HsnSacCodeRule, GstinPresenceRule + MismatchDetectionRule severity update (complete 2026-05-07)
- [x] 03-03-PLAN.md — Named template seeding: Standard (64 rows), Simplified (33 rows), Manufacturing (84 rows) with full TDS/GST metadata (complete 2026-05-07)
- [x] 03-04-PLAN.md — Frontend: MastersPage (Ledgers + Findings tabs), LedgerMappingPanel side sheet, OrganizationSetupPage two-step flow, DashboardPage sidebar, /masters route (complete 2026-05-07)
- [x] 03-05-PLAN.md — Integration tests: PreconfiguredMastersControllerIT, masters-with-tds-gaps.json fixture, ACCEPTED/OVERRIDDEN resolution ITs (complete 2026-05-07)
- [x] 03-06-PLAN.md — Gap 1 closure: DataInitializer backfillFindingSeverities() — migrates old INFO/WARNING/ERROR severity values to HIGH/MEDIUM/LOW on startup (complete 2026-05-07)
- [x] 03-07-PLAN.md — Gap 2 closure: fix ROLE_DATA_ENTRY_OPERATOR → ROLE_OPERATOR in /masters route guard and AppShell sidebar nav (complete 2026-05-07)
...
| 3. Masters TDS & GST Mapping Extension | 7/7 | Complete | 2026-05-07 |
